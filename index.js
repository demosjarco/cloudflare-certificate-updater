...
function createEcdsaCsr() {
	...
	const opensslArgs = ['req', '-new', '-sha512', '-key', fileName + '.key', '-out', fileName + '.csr', '-subj', '"/C=' + validateCountry() + '/ST=' + validateState() + '/L=' + validateLocation() + '/O=' + validateOrganization() + '/CN=' + validateCommonName() + '"'];
